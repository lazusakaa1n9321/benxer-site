...
$title =  "Rastgele Videolar - ".$genel_ayarlar['title']." | Video İzle | Video İndir | Video Seyret | Müzik Dinle | Müzik İndir";
...
<div id="icerik">
  ...
  <div id="sol">
        ...
        <div class="sol_kutu">
			...
			$video = mysql_query("SELECT * FROM lynvideo_video WHERE durum='1' ORDER BY rand() DESC limit $alt,$max");	
